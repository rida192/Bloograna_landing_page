    ...
    <section className="pt-10 ">
      <div className="container mx-auto md:max-w-3/4">
        <div className="flex flex-col-reverse md:flex-row   justify-between">
          <div className="md:w-1/2 flex flex-col gap-4 md:gap-8 px-10 md:px-0">
            ...
            <p className="text-center md:text-left text-[#696969]">
              With a combined experience in contracting and trading, we deliver
              excellence in construction, engineering, and material supply. Our
              commitment is to quality, safety, and timely delivery.
            </p>
